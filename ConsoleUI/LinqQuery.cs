...
namespace ConsoleUI
{
    ...
    {
        public static void MainLinqQuery()
        {
            ...
            List<Product> products = new List<Product>
            {
                ...
                new Product{ProductId=1,CategoryId=2,ProductName="Samsung Telefon",QuantityPerUnit="4 GB Ram",UnitPrice=5000,UnitInStock=15},
                new Product{ProductId=1,CategoryId=2,ProductName="Apple Telefon",QuantityPerUnit="4 GB Ram",UnitPrice=8000,UnitInStock=0},
            };
            //Test(products);
